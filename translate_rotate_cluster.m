...
%for i = 1:size(unwrapped_positions,1)
    unwrapped_tr(:,1) = unwrapped_positions(:,1) + translate(1);
    unwrapped_tr(:,2) = unwrapped_positions(:,2) + translate(2);
%end
...
%for i = 1:size(unwrapped_positions,1)
    ...
    x_prime = unwrapped_tr(:,1) - com(1);
    y_prime = unwrapped_tr(:,2) - com(2);
    ...
    unwrapped_rot(:,1) = x_new + com(1);
    unwrapped_rot(:,2) = y_new + com(2);
