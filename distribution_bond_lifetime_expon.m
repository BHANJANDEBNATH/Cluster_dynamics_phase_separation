...
function [bond_lifetimes] = distribution_bond_lifetime_expon(Num_conformation, conformation_diffusivity, num_samples);
...
inverse_exp_law = @(U, a, b) fsolve(@(t) a * exp(-b * t) - (1 - U), 1.0);
U = rand(num_samples, 1);
bond_lifetimes = arrayfun(@(u) inverse_exp_law(u, a, b), U);
