...
for i = 1:No_timesteps
    ...
    curr_time = i;
    bond_form_prob = 0.1;  % bond formation probability
    dis_factor = 10;       % distance criteria for bond formation
    ...
    %     outputname = ['Sim12_nb4_af01_power_lam05_alpha1_' num2str(i) '.mat'];     % change the name of file
    %     save(outputname)
    % end
