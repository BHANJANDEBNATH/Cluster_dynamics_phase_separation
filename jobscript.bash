...
# run the MATLAB code
matlab -nodisplay -nosplash -nodesktop -r "run('sim_nb3_af005_N1C00038.m');exit;" &
sleep 60
matlab -nodisplay -nosplash -nodesktop -r "run('sim_nb3_af005_N1C0034.m');exit;" &
sleep 60
matlab -nodisplay -nosplash -nodesktop -r "run('sim_nb3_af005_N25C0047.m');exit;" &
sleep 60
matlab -nodisplay -nosplash -nodesktop -r "run('sim_nb3_af005_N25C1.m');exit;" &
sleep 60
matlab -nodisplay -nosplash -nodesktop -r "run('sim_nb3_af005_N5C003.m');exit;" &
sleep 60
matlab -nodisplay -nosplash -nodesktop -r "run('sim_nb3_af005_N5C03.m');exit;" &
sleep 60
